...
5. **Write design doc** — save to obsidian vault for the project the format is `specs/YYYY-MM-DD-<topic>/design.md` and commit
...
- Write the validated design (spec) to the project vault on obsidian the document name should be `YYYY-MM-DD-<topic>-design.md`
...
> "Spec written and committed to vault `<path>`. Please review it and let me know if you want to make any changes"
